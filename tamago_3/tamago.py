...
[
    ...
    [22],
    [24],
    [28, ProjectileType.Bomb, MoveType.Yamanari],
    [32]
]
...
def draw_player(surface, player_state, elapsed_frame):
    ...
    surface.blit(img_player, (86, 320))
...
class Game:
    ...
    def reset(self):
        ...
        self.player_frame = 0
        self.pitcher_frame = 0  # ピッチャーが最後に投球した時刻（フレーム）
        self.score = 0
    ...
    def render(self, surface):
        ...
        # プレイヤーの描画
        draw_player(surface, self.player_state, self.game_state_frame - self.player_frame)
